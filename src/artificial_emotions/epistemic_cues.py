...
# Added with the v2 catalog — carried by the epistemic/volitional emotions and
# by the decomposition surface. Extend carefully; keep tests in sync.
TAG_OVERCLAIM_RISK = "overclaim_risk"
TAG_INSIGHT_CANDIDATE = "insight_candidate"
TAG_SCOPE_CREEP_RISK = "scope_creep_risk"
TAG_DEAD_END_RISK = "dead_end_risk"
