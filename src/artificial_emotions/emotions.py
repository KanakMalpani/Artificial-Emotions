...
Catalog load lives in ``emotions_catalog``; mix math lives in ``emotions_mix``.
This module keeps the public import path (cues, pack, re-exports).
...
from artificial_emotions.emotions_catalog import emotion_catalog
from artificial_emotions.emotions_mix import feel, mix_emotions
