...
Public surface stays ``artificial_curiosity.agent_tools`` — this package is the
...
from artificial_curiosity.agent_tools_pkg.mcp_resources import (
    mcp_resource_list,
    mcp_resource_read,
)
from artificial_curiosity.agent_tools_pkg.registry import (
    HANDLERS,
    TOOL_SPECS,
    dispatch_tool,
    mcp_tool_list,
...
from artificial_curiosity.agent_tools_pkg.schemas import (
