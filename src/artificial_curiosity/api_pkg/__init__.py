...
Public entry point stays ``artificial_curiosity.api:app`` — this package is the
...
from artificial_curiosity.api_pkg.error_handlers import register_error_handlers
from artificial_curiosity.api_pkg.routers import (
    curiosity,
    emotions,
    evaluation,
    meta,
...
from artificial_curiosity.api_pkg.security import OptionalApiKeyMiddleware
from artificial_curiosity.config import cors_origins
