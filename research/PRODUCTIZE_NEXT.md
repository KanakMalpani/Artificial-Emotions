...
21. **Web constitution compare + veto** — In-tree (`constitution_compare`); keep feasible-set honesty ([`CONSTITUTION_WEB_UX.md`](CONSTITUTION_WEB_UX.md), [`MULTI_STAKEHOLDER_FEASIBLE_SET.md`](MULTI_STAKEHOLDER_FEASIBLE_SET.md)).
