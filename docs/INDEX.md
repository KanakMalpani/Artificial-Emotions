...
**Design rationale (optional):** [`research/`](../research/) — first principles, failure modes, sources. Research informed the code; it is not the homepage. Affect / epistemic-emotion background: [`research/AI_EMOTIONS.md`](../research/AI_EMOTIONS.md). Product how-to: [`EMOTIONS.md`](EMOTIONS.md).
