...
| F7 | Hallucinated gap | Invents empty literature | Require retrieved paper evidence for gap claims |
| F8 | Overconfident scores | Fake precision | Confidence intervals from judge variance + evidence strength |
